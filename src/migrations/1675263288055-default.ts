...
export class default1675263288055 implements MigrationInterface {
    name = 'default1675263288055'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "videos" ADD CONSTRAINT "FK_64bb2d8544299bbde670698ac37" FOREIGN KEY ("room_id") REFERENCES "rooms"(id) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
